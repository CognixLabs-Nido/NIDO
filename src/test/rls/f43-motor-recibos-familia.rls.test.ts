...
// D-6 — beca comedor variable por mes (tabla `beca_comedor_mes` + PASE 2-bis del motor)
// RETIRADA en V2-6: el motor B2-1 sustituyó ese pase por la beca comedor v2 a nivel familia
// (líneas "Beca comedor <mes>" desde `beca_comedor_tramo`). Cobertura del nuevo motor en
// `b2-1-motor-beca-v2.rls.test.ts`. La tabla `beca_comedor_mes` se dropea en esta misma fase.
